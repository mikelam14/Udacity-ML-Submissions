...
class Simulator(object):
    ...
    def __init__(self, env, size=None, update_delay=2.0, display=True, log_metrics=False, optimized=False):
        ...
        if self.log_metrics:
            ...
            self.log_fields = ['trial', 'testing', 'parameters', 'initial_deadline', 'final_deadline', 'net_reward', 'actions', 'success','states_visited','zCount']
        ...
        while True:
            ...
            if self.log_metrics:
                self.log_writer.writerow({
                    ...
                    'states_visited': len(self.env.primary_agent.Q.keys()),
                    'zCount': getZeroCount(self.env.primary_agent.Q)
                })
